...
import com.toolkit.sit.models.IScanModel

class ScanAdapter(options: FirestoreRecyclerOptions<IScanModel>)
    :FirestoreRecyclerAdapter<IScanModel, NetworkScanView>(options) {
    ...
    override fun onBindViewHolder(holder: NetworkScanView, position: Int, model: IScanModel) {
